...
def window_of_dashboard(parent_window):
    ...
    # butto to clear user's input text
    def clear_input():
        ...
        def stream_response():
            try:
                ...
                for chunk in stream:
                    ...
                    latest_ai_response[0] += content # append each word to the list to store complete AI output.
                # ----------------------
    ...
    # function for TTS
    def speak():
        text_for_TTS = latest_ai_response[0]
